 ...
 *
 */
public class ElementEditFrame extends JFrame {
	/**
	 * 呼び出し元画面
	 */
	final int LINES = 14;
...
//		ValueSelectPanel
	...
	static class SubmitButtonPanel extends JPanel {
		SubmitButtonPanel(final EditPanel editPanel, final ElementEditFrame tf) {
	...
	static class ValueInputPanel extends JPanel {
		...
		public ValueInputPanel(ElementEditFrame frame, int param_index, String comment, String ini, InputChecker checker) {
