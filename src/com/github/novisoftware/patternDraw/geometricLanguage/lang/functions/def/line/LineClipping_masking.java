...
public class LineClipping_masking  implements FunctionDefInterface {
	public static final String NAME = "line_masking";
	...
	public String getDescription() {
		return "線分の系列を点の並びで囲まれる図形でマスキングします。";
	}
	...
	public Value exec(List<Value> param, InstructionRenderer t) throws CaliculateException {
		...
		return new ValueLineList(PosClipUtil.lineClip(lineList, region, true));
	}
}
